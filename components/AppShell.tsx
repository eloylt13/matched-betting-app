...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const showBetfairBanner = pathname === '/casas'
      ...
      {showBetfairBanner ? (
        <div className="hidden md:block border-b border-white/10 bg-[linear-gradient(135deg,rgba(10,11,24,0.88)_0%,rgba(23,16,45,0.9)_45%,rgba(43,31,67,0.92)_100%)]">
          <div className="mx-auto max-w-7xl px-4 py-2.5 sm:px-6 lg:px-8">
            <div className="relative overflow-hidden rounded-2xl border border-violet-200/14 bg-white/[0.045] px-4 py-2.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_16px_42px_rgba(15,23,42,0.18)] backdrop-blur-md">
              ...
              <div className="pointer-events-none absolute -left-10 -top-10 h-24 w-24 rounded-full bg-violet-500/12 blur-3xl" />
              <div className="relative flex flex-col gap-2.5 lg:flex-row lg:items-center lg:justify-between">
                <div className="flex items-center gap-3">
                  <div className="flex h-9 w-9 items-center justify-center rounded-2xl border border-violet-200/20 bg-violet-300/10 text-sm font-semibold text-violet-100 shadow-[0_10px_22px_rgba(124,58,237,0.16)]">
                    B
                  </div>
