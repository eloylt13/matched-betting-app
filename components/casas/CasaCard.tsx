...
export function CasaCard({ casa, estado }: Props) {
  ...
  return (
    <Link
      href={`/casas/${casa.id}`}
      className={`relative isolate block rounded-2xl border border-violet-100/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.94)_0%,rgba(248,250,255,0.9)_46%,rgba(255,255,255,0.96)_100%)] shadow-[inset_0_1px_0_rgba(255,255,255,0.85),0_18px_44px_rgba(15,23,42,0.1),0_6px_18px_rgba(88,28,135,0.06)] ${style.border} overflow-hidden transition-all duration-300 ease-out before:pointer-events-none before:absolute before:inset-y-4 before:left-0 before:z-0 before:w-px before:rounded-r-full before:content-[''] after:pointer-events-none after:absolute after:inset-y-0 after:left-0 after:z-0 after:w-16 after:content-[''] group hover:-translate-y-0.5 hover:border-violet-200/90 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.92),0_24px_58px_rgba(15,23,42,0.14),0_10px_28px_rgba(88,28,135,0.11),0_0_0_1px_rgba(124,58,237,0.05)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-300/60 focus-visible:ring-offset-2 focus-visible:ring-offset-white ${completada ? 'opacity-60' : ''}`}
    >
