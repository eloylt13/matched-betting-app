...
export default function BottomNav() {
  ...
  const navItems: BottomNavItem[] = [
    ...
    { name: 'Recurrentes', path: '/beneficios-recurrentes', icon: 'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9' },
  ]

  return (
    <div className="fixed inset-x-3 bottom-[calc(0.5rem+env(safe-area-inset-bottom))] z-50 md:hidden">
      <div className="grid h-[4.75rem] grid-cols-6 overflow-hidden rounded-[1.5rem] border border-white/10 bg-[linear-gradient(135deg,rgba(9,11,24,0.94)_0%,rgba(18,17,42,0.96)_46%,rgba(42,31,61,0.94)_100%)] px-1 py-1 shadow-[0_18px_54px_rgba(2,6,23,0.3)] backdrop-blur-xl">
        {navItems.map((item) => {
