...
export default function BottomNav() {
  ...
  const navItems = [
    { name: 'Inicio', path: '/', icon: 'M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z' },
  ...
  return (
    <div className="flex md:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#12112A] border-t border-white/10 h-16">
      {navItems.map((item) => {
