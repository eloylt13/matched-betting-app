...
export const combinadaDelDia: CombinadaData = {
  ...
  motivoGeneral:
    'Combinada de respaldo centrada en mercados de goles y ganador con perfil conservador para no interrumpir la vista diaria.',
  picks: [
    ...
    { text: 'Celtic vs St. Mirren · Más de 2.5 goles @ 1.66', motivoBreve: 'Pick de respaldo visible; puede diferir del filtro automático si faltan datos.' },
  ],
}
