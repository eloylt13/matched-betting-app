      ...
      <section className="rounded-3xl border border-emerald-200 bg-white p-5 sm:p-6 shadow-sm">
        <div className="flex flex-col gap-2 mb-5">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-stone-800">
            Sigue tu progreso, tus bonos y tus siguientes pasos desde un solo sitio
          </h1>
          <p className="text-sm text-stone-500">
            {market === 'espana'
              ? 'Pensado para operar primero en España, con una ruta clara para avanzar entre casas, bonos y calculadora.'
              : 'También puedes usarlo con fichas LATAM para ver progreso, bonos pendientes y próximas acciones en un solo panel.'}
          </p>
        </div>
