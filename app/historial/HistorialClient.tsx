  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          <h1 className="text-2xl font-bold text-stone-100">📋 Historial y resultados de tus operaciones</h1>
          <p className="text-stone-400 text-sm mt-1">
            Revisa el resultado final de cada operación para mantener control y seguimiento, tanto en España como en fichas LATAM
          </p>
        </div>
        <button
